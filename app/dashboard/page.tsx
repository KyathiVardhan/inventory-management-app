...
export default async function DashboardPage() {
    ...
    for (let i = 11; i >= 0; i--) {
        ...
        const weekLabel = `${String(weekStart.getMonth() + 1).padStart(2, "0")}/${String(weekStart.getMonth() + 1).padStart(2, "0")}`
    ...
    const ioutOfStockPercentage = totalProducts > 0 ? Math.round(outOfStockCount / totalProducts)*100:0
            ...
            <main className="ml-64 p-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                    ...
                    <div className="bg-white rounded-lg border border-gray-200 p-6">
                        ...
                        <div className="h-48">
                            <ProductsChart data={weeklyProductionData} />
                        </div>
                    </div>
                </div>
                    ...
                    <div className="bg-white rounded-lg border border-gray-200 p-6">
                        ...
                        <div className="space-y-3 ">
                            {recent.map((product, key) => {
                                const stockLevel = product.quantity === 0 ? 0 : product.quantity <= (product.lowStock || 5) ? 1 : 2;
                        ...
                        <div className="flex items-center justify-center">
                            <div className="relative w-48 h-48">
                                ...
                                <div className="absolute inset-0 rounded-full border-8 border-purple-600"
                                    style={{
                                        clipPath: "ploygon(50% 50%, 50% 0%, 100% 0%, 0% 100%, 0% 100%, 0% 50%)",
                                    }}>
